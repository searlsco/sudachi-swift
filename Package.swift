...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/searlsco/sudachi-swift/releases/download/v0.3.1/Sudachi.xcframework.zip",
            checksum: "1e00a896b5331d92c85379790f01b60a61d1886114a30257c4a743692f68e246"
        ),
        .target(
            name: "Sudachi",
